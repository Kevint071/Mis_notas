...
lista_palabras = {"Set back": "Retrasar", 
    "Fix up": "Arreglar",
    "Figure out": "Analizar hasta entender",
    "Win over": [["Estar de acuerdo con alguien"],["Estar de acuerdo conmigo"]],
    "Call off": "Cancelar",
    "Take on": ["Contratar",["Aceptar responsabilidad"]],
    "Tell of": "Criticar",
